...
const ActivityDetailModal = ({ modal, setModal, data }: { modal: boolean, setModal: (modal: boolean) => void, data: any }) => {
        ...
        <Modal
          ...
          <View
              ...
              ></View>
                    ...
                    {
                        !editable && 
                        <View style={{ width: '100%', alignItems: 'flex-end', marginTop:20, paddingHorizontal: 11 }} {...panResponder.panHandlers}>
                    ...
                    {
                        editable && 
                        <View style={{ width: '100%',      marginTop:20,                        minHeight: 40, marginBottom:4, alignItems: 'center', justifyContent: "space-between", paddingHorizontal: 11, flexDirection: "row" }} {...panResponder.panHandlers}>
                    ...
                    <ScrollView style={{ flex: 1, width: '100%', flexDirection: 'column', paddingHorizontal: 24, marginTop: 16 }}>
                        ...
                        {/* title */}
                        <View style={{ width: "100%", marginTop: 10, zIndex: -10000 }}>
