      ...
      onDismiss={() => setModal(false)}
          ...
          <View
              ...
              ></View>
                    ...
                    {
                        editable && 
                        <View style={{ width: '100%',  minHeight: 40, marginBottom:4, alignItems: 'center', justifyContent: "space-between", paddingHorizontal: 11, flexDirection: "row" }} 
                        //{...panResponder.panHandlers}
                        >
                    ...
                    <ScrollView style={{ flex: 1, flexDirection: 'column', paddingHorizontal: 24, marginTop: 16 }}>
