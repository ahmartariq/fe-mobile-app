...
import { Modal, View, Text, Pressable, PanResponder, StyleSheet, Platform, TouchableOpacity, ScrollView, ViewStyle, KeyboardAvoidingView } from 'react-native'
...
const QuickActivityModal = ({ modal, setModal }: { modal: boolean, setModal: (modal: boolean) => void }) => {
    ...
    const [errorMessages, setErrorMessages] = useState({ type , title: '', description: '' });
    ...
    const handleAdd = () => {
        ...
        if(title === ""){
            setErrorMessages({ ...errorMessages, title: "Please enter title", type: "" });
            return;
        }
        if(description === ""){
            setErrorMessages({ ...errorMessages, description: "Please enter description", title: "", type: "" });
            return;
        }
                    ...
                    <ScrollView style={{ flex: 1, width: '100%', flexDirection: 'column', paddingHorizontal: 24, marginTop: 16 }}>
                        ...
                        <View style={{ width: "100%" }}>
                            ...
                            <DropDownPicker
                                ...
                                dropDownContainerStyle={{ backgroundColor: "#FDFDFD", borderColor: "#949F99", borderRadius: 9, borderWidth: 1 , zIndex: 1000}}
                            ...
                            />
                            {errorMessages.type !== "" && <Text style={{ color: 'red', fontSize: 12, marginTop: 4 }}>{errorMessages.type}</Text>}
                        </View>
                        ...
                        <View style={{ width: "100%", marginTop: 10, zIndex: -1000 }}>
                            ...
                            />
                            {errorMessages.title !== "" && <Text style={{ color: 'red', fontSize: 12, marginTop: 4 }}>{errorMessages.title}</Text>}
                        </View>
                        ...
                        <View style={{ width: "100%", marginTop: 10 }}>
                            ...
                            <TextInput
                                ...
                                numberOfLines={7}
                            />
                            {errorMessages.description !== "" && <Text style={{ color: 'red', fontSize: 12, marginTop: 4 }}>{errorMessages.description}</Text>}
                        </View>
