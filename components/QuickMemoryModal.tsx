...
const QuickMemoryModal = ({ modal, setModal}: { modal: boolean, setModal: (modal: boolean) => void}) => {
                    ...
                    <ScrollView style={{ flex: 1, width: '100%', flexDirection: 'column', paddingHorizontal: 24, marginTop: 16 }}>
                        ...
                        <View style={{ width: "100%", marginTop: 10 }}>
                            ...
                            <TextInput
                                ...
                                numberOfLines={7}
                            />
                            {errorMessages.description !== '' && <Text style={{ color: 'red', fontSize: 12 }}>{errorMessages.description}</Text>}
                        </View>
