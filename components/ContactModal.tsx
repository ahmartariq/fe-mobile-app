...
const activity = [
    {
        ...
        description: "Um weitere Infos zu besprechen haben wir per Mail einen Termin vereinbart, um asdasdads Um weitere Infos zu besprechen haben wir per Mail einen Termin vereinbart, um asdasdads",
    ...
    },
    {
        ...
        description: "30 min. telefoniert und über Einsatzmöglichkeiten der Software gesprochen.",
...
const remainder = [
    ...
    {
        description :"Anrufen und fragen wie der Vortrag auf dem Fin-Summit gelaufen ist",
    ...
    {
        description :"Gespräch für die kommende Messe planen und Termin vereinbaren ",
...
const ContactModal = ({ contactModel, setContactModel, data, infoData }: { contactModel: boolean, setContactModel: (contactModel: boolean) => void, data: any, infoData: any }) => {
    ...
    return (
        <Modal
            ...
            <View style={styles.centeredView}>
                        ...
                        {/* Profil */}
                        {
                            ...
                            <ScrollView style={{ width: '100%', flexDirection: "column", marginTop: 22, height: '50%' }}>
                                    ...
                                    {editable || info.telefon !== "" ? (
                                        <View style={{ width: "100%", flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#C9C9C9" }}>
                                            ...
                                            <TextInput
                                                ...
                                                value={info.telefon}
                                                onChangeText={(text) => setInfo({ ...info, telefon: text })}
                                                editable={editable}
                                            />
                                        </View>
                                    ) : null}
                                    {editable || info.email !== "" ? <View style={{ width: "100%", flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#C9C9C9", }}>
                                ...
                                <View style={{ flexDirection: "column", marginBottom: 22 }}>
                                    ...
                                    {editable || info.wohnort !== "" ? <View style={{ width: "100%", flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#C9C9C9", }}>
                                        ...
                                        <TextInput
                                            ...
                                            placeholderTextColor="#D0D0D0"
                                            value={info.wohnort}
                                            onChangeText={(text) => setInfo({ ...info, wohnort: text })}
                                            editable={editable}
                                        />
                                    </View>
                                        : null}
                                ...
                                <View style={{ flexDirection: "column", marginBottom: 22 }}>
                                    ...
                                    {editable || info.beruf !== "" ? <View style={{ width: "100%", flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#C9C9C9", }}>
                                        ...
                                        <TextInput
                                            ...
                                            placeholderTextColor="#D0D0D0"
                                            value={info.beruf}
                                            onChangeText={(text) => setInfo({ ...info, beruf: text })}
                                            editable={editable}
                                        />
                                    </View>
                                        : null}

                                    {editable || info.unternehmen !== "" ? <View style={{ width: "100%", flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#C9C9C9", }}>
                                        ...
                                        <TextInput
                                            ...
                                            onChangeText={(text) => setInfo({ ...info, unternehmen: text })}
                                            editable={editable}
                                        />
                                    </View>
                                        : null}
                                ...
                                <View style={{ flexDirection: "column", marginBottom: 22 }}>
                                    ...
                                    {editable || info.verbindungsperson !== "" ? <View style={{ width: "100%", flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#C9C9C9", }}>
                                        ...
                                        <TextInput
                                            ...
                                            onChangeText={(text) => setInfo({ ...info, verbindungsperson: text })}
                                            editable={editable}
                                        />
                                    </View>
                                        : null}
                                    {editable || info.kreis !== "" ? <View style={{ width: "100%", flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "#C9C9C9", }}>
                                        ...
                                        <TextInput
                                            ...
                                            placeholderTextColor="#D0D0D0"
                                            value={info.kreis}
                                            onChangeText={(text) => setInfo({ ...info, kreis: text })}
                                            editable={editable}
                                        />
                                    </View>
                                        : null}
                            ...
                            <>
                                <View style={{ width: "100%", alignItems: "flex-end" }}>
                                    <TouchableOpacity activeOpacity={0.5} onPress={() => {
                                        setActivityData({title: "", description: "", date: '', time: '', type: ''})
                                        setActivityModal(true)
                                    }} style={{ borderWidth: 1, borderColor: "#7F7F7F", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10 }}>
                                        <Text style={{ color: "#515151", fontSize: 14, fontWeight: "600" }}>+ Aktivität</Text>
                                    </TouchableOpacity>
                                </View>
                                <ScrollView style={{ width: '100%', flexDirection: "column", marginTop: 22, height: '50%' }}>
                                    {
                                        activity.map((item, index) => (
                                            <TouchableOpacity key={index} activeOpacity={0.5} onPress={() => {setActivityData(item) ;setActivityModal(true) }} style={{ flexDirection: 'row', width: "100%", marginBottom: 10 }}>
                                                <View style={{ flexDirection: "column", width: "15%", position: 'relative' }}>
                                                    <View style={{ width: 38, height: 38, borderWidth: 1, borderColor: "#E4E8F4", backgroundColor: "#F1F5FF", borderRadius: 100, alignItems: 'center', justifyContent: 'center', zIndex: 1 }}>
                                                        <SvgXml
                                                            xml={item.type === "Email" ? email : item.type === "Telefonat" ? phone : group}
                                                            width={18}
                                                            height={18} />
                                                    </View>
                                                    <View style={{ height: "100%", position: "absolute", width: 1, borderWidth: 1, borderColor: "#D0D9F1", borderStyle: "dashed", zIndex: -1, left: 18 }}></View>
                                                </View>
                                                <View style={{ width: "85%", paddingHorizontal: 12, paddingVertical: 14, flexDirection: "column", backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E7EBF4", borderRadius: 12 }}>
                                                    <Text style={{ fontSize: 14, fontWeight: "500", color: "black", marginBottom: 6 }}>{item.title}</Text>
                                                    <Text style={{ fontSize: 12, color: "#545454", marginBottom: 10 }} numberOfLines={2} ellipsizeMode="tail">{item.description}</Text>
                                                    <View style={{ flexDirection: "row", alignItems: 'center' }}>
                                                        <SvgXml xml={caalender} width={16} height={16} />
                                                        <Text style={{ marginLeft: 6, fontSize: 12, color: "#676767" }}>{dateFormat(item.date)}</Text>
                                                        {
                                                            item.time &&
                                                            <>
                                                                <SvgXml xml={clock} width={16} height={16} style={{ marginLeft: 20 }} />
                                                                <Text style={{ marginLeft: 6, fontSize: 12, color: "#676767" }}>{item.time}</Text>
                                                            </>
                                                        }
                                                    </View>
                                                </View>
                            ...
                            <>
                                <View style={{ width: "100%", alignItems: "flex-end" }}>
                                    <TouchableOpacity activeOpacity={0.5} onPress={() => {
                                        ...
                                        <Text style={{ color: "#515151", fontSize: 14, fontWeight: "600" }}>+ Erinnerung</Text>
                                    </TouchableOpacity>
                                </View>
                                <ScrollView style={{ width: '100%', flexDirection: "column", marginTop: 22, height: '50%' }}>
                                    {
                                        remainder.map((item, index) => (
                                            <TouchableOpacity key={index} activeOpacity={0.5} onPress={() => {setRemainderData(item) ;setRemainderModal(true) }} 
                                            style={{ padding: 12, flexDirection: 'column', width: "100%", marginBottom: 12, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E7EBF4", borderRadius: 12  }}>
                                                    <View style={{ flexDirection: "row", alignItems: 'center' }}>
                                                        <SvgXml xml={caalender} width={16} height={16} />
                                                        <Text style={{ marginLeft: 6, fontSize: 12, color: "#676767" }}>{dateFormat(item.date)}</Text>
                                                                <SvgXml xml={clock} width={16} height={16} style={{ marginLeft: 20 }} />
                                                                <Text style={{ marginLeft: 6, fontSize: 12, color: "#676767" }}>{new Date(item.date).getHours() + ":" + new Date(item.date).getMinutes()}</Text>
                                                    </View>
                                                    <Text style={{ fontSize: 14, color: "#1F1F1F", marginTop: 10, fontWeight: "400" }} numberOfLines={2} ellipsizeMode="tail">{item.description}</Text>
                            ...
                            <>
                                <View style={{ width: "100%", alignItems: "flex-end" }}>
                                    <TouchableOpacity activeOpacity={0.5} onPress={() => {
                                        ...
                                        <Text style={{ color: "#515151", fontSize: 14, fontWeight: "600" }}>+ Ansatz</Text>
                                    </TouchableOpacity>
                                </View>
                                <ScrollView style={{ width: '100%', flexDirection: "column", marginTop: 22, height: '50%' }}>
                                    {
                                        approaches.map((item, index) => (
                                            <TouchableOpacity key={index} activeOpacity={0.5} onPress={() => {setApproachData(item) ;setApproachModal(true) }} 
                                            style={{ padding: 12, flexDirection: 'column', width: "100%", marginBottom: 12, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E7EBF4", borderRadius: 12  }}>
                                                    <Text style={{ fontSize: 14, color: "black", marginTop: 10, fontWeight: "500" }} numberOfLines={2} ellipsizeMode="tail">{item.title}</Text>
                                                    <Text style={{ fontSize: 14, color: "#1F1F1F", marginTop: 10, fontWeight: "400" }} numberOfLines={2} ellipsizeMode="tail">{item.description}</Text>
                                            </TouchableOpacity>
                                        ))}
                                </ScrollView>
                ...
                <ActivityDetailModal modal={activityModal} setModal={setActivityModal} data={activityData} />
                <ReminderDetailModal modal={remainderModal} setModal={setRemainderModal} data={remainderData} />
                <ApproachDetailModal modal={approachModal} setModal={setApproachModal} data={approachData} />
            </View>
        </Modal>
    )
}
